...
const APP_ID = "bda40db6";
const APP_KEY = "2318a8b5bc324b1a529d5f7656b72b7e";
...
const AppComponent = () => {
  ...
  return (
    <Container>
      <Header>
        <AppName>
          <RecipeImage src="/react-recipe-finder/logo.svg" />
          Millennial Cooking
        </AppName>
        <SearchBox>
      ...
      <RecipeListContainer>
        {recipeList?.length ? (
          ...
          <Placeholder src="/react-recipe-finder/cookingbg.svg" />
        )}
      </RecipeListContainer>
    </Container>
  );
